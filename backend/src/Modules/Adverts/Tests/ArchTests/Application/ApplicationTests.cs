...
using AutoHub.Modules.Adverts.Application.Configuration.Queries;
using AutoHub.Modules.Adverts.Application.Contracts;
using AutoHub.Modules.Adverts.ArchTests.SeedWork;
...
namespace AutoHub.Modules.Adverts.ArchTests.Application
{
    [TestFixture]
