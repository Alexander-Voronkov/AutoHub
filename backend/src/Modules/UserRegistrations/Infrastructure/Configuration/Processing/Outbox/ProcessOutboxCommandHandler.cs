...
namespace AutoHub.Modules.UserRegistrations.Infrastructure.Configuration.Processing.Outbox
{
    internal class ProcessOutboxCommandHandler : ICommandHandler<ProcessOutboxCommand>
    {
        ...
        public async Task Handle(ProcessOutboxCommand command, CancellationToken cancellationToken)
        {
            ...
            const string sql = $"""
                               ...
                               FROM `registrations_OutboxMessages` AS `OutboxMessage` 
            ...
            const string sqlUpdateProcessedDate = """
                                                  UPDATE `registrations_OutboxMessages` 
