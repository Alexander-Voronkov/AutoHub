...
using AutoHub.Modules.UserRegistrations.Domain.UserRegistrations.Rules;
...
public class UserRegistration : Entity, IAggregateRoot
{
    ...
    private UserRegistration(
        ...
        string confirmLink)
    {
        this.CheckRule(new UserEmailMustBeUniqueRule(usersCounter, login));
    ...
    public void Confirm()
    {
        ...
        this.AddDomainEvent(new UserRegistrationConfirmedDomainEvent(this.Id, _login, _email, _firstName, _lastName, _name, _password, _registerDate));
    }
